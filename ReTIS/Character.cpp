...
void cEnemyJugem::Render(int img[])
{
	...
	DrawFormatString((int)FocusPos.x, (int)FocusPos.y, 0xFFFFFF, "%d", hp);
...
{
	DrawBoxAA(pos.x - size.x / 2.f, pos.y - size.y / 2.f, pos.x + size.x / 2.f, pos.y + size.y / 2.f,0xfffff,true);
}
